...
document.getElementById("prix-total").innerHTML = (totalCart+" €");
// Stockage du prix total dans Local Storage pour recupérer sur la page de confirmation
...
function CartProductId() {
    ...
    let products = []; // Pour ranger le contenu du panier dans un array
...
/* Function avec fetch pour envoyer les données
function postAPI(dataToPost) {
fetch("http://localhost:3000/api/cameras/order");
};*/

// Fonction pour récuperer Id de la commande
